...
do 
  echo "ec2 import-key-pair --region ${REGION} --key-name \"${KEYNAME}\" --public-key-material file://${PUBFILE}"
  #ec2 import-key-pair --region ${REGION} --key-name "${KEYNAME}" --public-key-material file://${PUBFILE}
done
